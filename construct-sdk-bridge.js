(function () {
  ...
  function patchPlaygama() {
    ...
    bridge.game = eventEmitter(bridge.game || {});
    ...
    bridge.advertisement = eventEmitter(bridge.advertisement || {});
    ...
    ads.showInterstitial = function () {
      ads._emit("interstitial_state_changed", "opened");
      return finishInterstitial("playgama", function () {
        ads._emit("interstitial_state_changed", "closed");
      });
    };
    ads.showRewarded = function (options) {
      ads._emit("rewarded_state_changed", "opened");
      return grantReward("playgama", function () {
        ads._emit("rewarded_state_changed", "rewarded");
        if (options && typeof options.afterClose === "function") options.afterClose(true);
      }).then(function () {
        ads._emit("rewarded_state_changed", "closed");
        return true;
      });
    };
